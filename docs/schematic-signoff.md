...
| [ ] | [`water_meters.kicad_sch`](../projects/wanos-board/water_meters.kicad_sch) | **J4** TE **5556416-1** (TH no-LED); YF front-end **R37**–**R44**, **C18**–**C21**, TVS **D25**–**D29**, LEDs **D13**–**D16** / **R19**–**R22**; `WM_*` → `EXP_A_P2`…`P5` |
