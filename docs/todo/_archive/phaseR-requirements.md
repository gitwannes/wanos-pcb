...
**Related:** [`board-spec.md`](../board-spec.md) · [`field-wiring.md`](../field-wiring.md) · [`gpio-interface.md`](../gpio-interface.md) · [`external-plant.md`](../external-plant.md) · [`grounding.md`](../grounding.md) · Sequence → [`pipeline.md`](pipeline.md).
